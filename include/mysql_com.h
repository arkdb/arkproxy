...
#define ENV_SET_NAMES "names"
#define ENV_USE_DB "db"
...
/* for proxy */
#define PROXY_CONNECT_SHELL 1
#define PROXY_CONNECT_PROXY 2
...
enum trace_queue_state{
    TRACE_STATE_EMPTY, /* never been used */
    TRACE_STATE_BUSY,  /* been used */
    TRACE_STATE_FORMAT,  /* been used */
    TRACE_STATE_RESET, /* has been used, but thd is released */
};
