...
public:
  ...
  */    
  ...
  bool hide; ///< true if the value is in character_set_filesystem
...
public:
  sys_var(sys_var_chain *chain, const char *name_arg, const char *comment,
          ...
          const char *substitute, my_bool hide);
...
public:
  set_var_user(Item_func_set_user_var *item)
    :user_var_item(item)
  { strcpy(set_var_type, "set_user_var"); }
  int check(THD *thd);
  int update(THD *thd);
  int light_check(THD *thd);
  Item_func_set_user_var* get_var_user(){return user_var_item;}
};
...
public:
  ...
  set_var_collation_client(int set_cs_flags_arg,
    ...
    {strcpy(set_var_type,"set_var_collation");}
  int check(THD *thd);
  int update(THD *thd);
