...
enum enum_sub_command {
  CFG_CMD_OFFLINE_SERVER, CFG_CMD_ONLINE_SERVER,CFG_CMD_RELOAD,
  CFG_CMD_FLUSH,CFG_CMD_SHOW_CACHE_LIST, CFG_CMD_DELETE_CONFIG,
  CFG_CMD_USER_SET, CFG_CMD_SHOW_USER_CONFIG_LIST,
  SQLCOM_SHOW_BACKEND_CONN, SQLCOM_SHOW_PROXY_STATUS, SQLCOM_SHOW_PROXY_CONN_STATUS,
  SQLCOM_SHOW_BACKEND_SERVERS, SQLCOM_SHOW_BACKEND_ROUTES,
  SQLCOM_SHOW_TRACE_STATUS, SHELL_CMD_FULL_TRACE_STATUS, CONFIG_HELP,
  CFG_ADD_SERVER,CFG_DELETE_SERVER,CFG_CMD_WRITE,SQLCOM_SHOW_CONN,SQLCOM_SHOW_THREADPOOL,
  CFG_TRACE_CLOSE, CFG_TRACE_SQL_CLOSE, CFG_TRACE_CREATE, CFG_TRACE_SQL_CREATE,
  CFG_RULE_ADD,CFG_RULE_UPDATE,CFG_RULE_DELETE,CFG_RULE_DELETE_ALL,
  SQLCOM_SHOW_RULE_STATUS,CFG_ADD_ROUTE,CFG_ONOFFLINE_ROUTE,CFG_DELETE_ROUTE,
  CFG_CMD_END
};
