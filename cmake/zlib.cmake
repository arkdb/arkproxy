...
MACRO (MYSQL_CHECK_RDKAFKA)
    FIND_PATH(RDKAFKA_ROOT_DIR NAMES librdkafka)
    FIND_LIBRARY(RDKAFKA_LIBRARY NAMES librdkafka.a "")
    MESSAGE("rdkafka head path: ${RDKAFKA_ROOT_DIR}/librdkafka, lib: ${RDKAFKA_LIBRARY}")

    IF (RDKAFKA_ROOT_DIR AND RDKAFKA_LIBRARY)
        #ADD_DEFINITIONS(-DHAVE_RDKAFKA_H = 1)
      LINK_LIBRARIES(${RDKAFKA_LIBRARY})
      SET(RDKAFKA_INCLUDE_DIR ${RDKAFKA_ROOT_DIR}/librdkafka)
    ELSE()
	  MESSAGE(FATAL_ERROR "Required rdkafka library is not found")
    ENDIF()
ENDMACRO()
